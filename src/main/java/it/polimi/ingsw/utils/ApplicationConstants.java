...
public class ApplicationConstants {
    public static final int DISCONNECTION_TIMER_NOT_ENOUGH_PLAYER = 30000; //time after which to call game over from disconnection, in milliseconds
    public static final int DISCONNECTION_TIMER_PING = 5000; //time after which to call endpoint disconnection, if no message is recieved, in milliseconds
